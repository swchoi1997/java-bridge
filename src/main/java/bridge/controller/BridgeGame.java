...
import static bridge.model.Judgment.CROSSING;
import static bridge.model.Judgment.FAIL;
...
public class BridgeGame {
     ...
     */
    public StepResponseDto move(String moving) {
        if (FAIL == score.goOneStep(bridge, moving)) {
            return new StepResponseDto(score, false);
        }
        if (CROSSING == score.isCrossing(bridge)) {
     ...
     */
    public String retry(String retry) {
        return score.retryGame(retry);
    }
